...
export default function Courses() {
  const undergraduateCourses: Course[] = [
    ...
    { name: '社會統計 (Social Statistics)', syllabusLink: '/ping-yin-kuan-website/files/Social_Statistics_Syllabus.docx', lectureLink: '/ping-yin-kuan-website/files/Social_Statistics_Syllabus.docx' },
